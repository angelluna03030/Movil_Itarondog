...
class HistorialCompra extends StatefulWidget {
  @override
  State<HistorialCompra> createState() => _HistorialCompraState();
}

class _HistorialCompraState extends State<HistorialCompra> {
  Color myColor = const Color(0xff32323f);
